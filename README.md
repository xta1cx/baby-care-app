...
赤ちゃんのミルク・おむつ・睡眠を簡単に見やすく記録するWebアプリです。
...
Java・Servlet・JSPなどの学習成果を活かし、実際の利用から想定したWebアプリケーションの開発を目的として制作しました。
以前使用していた育児アプリを参考に、使いにくいと感じた点を改善し、より使いやすくなるよう機能を追加しました。
